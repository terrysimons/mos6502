...
def test_mos6502_C_flag():
    ...
    # Test bitwise xor
    cpu.C = 0
    assert (cpu.C ^ flags.ProcessorStatusFlags.C[flags.C]) == (flags.ProcessorStatusFlags.C[flags.C] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.C])
    cpu.C = 1
    assert (cpu.C ^ flags.ProcessorStatusFlags.C[flags.C]) == (flags.ProcessorStatusFlags.C[flags.C] ^ flags.ProcessorStatusFlags.C[flags.C])
...
def test_mos6502_Z_flag():
    ...
    # Test bitwise xor
    cpu.Z = 0
    assert (cpu.Z ^ flags.ProcessorStatusFlags.Z[flags.Z]) == (flags.ProcessorStatusFlags.Z[flags.Z] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.Z])
    cpu.Z = 1
    assert (cpu.Z ^ flags.ProcessorStatusFlags.Z[flags.Z]) == (flags.ProcessorStatusFlags.Z[flags.Z] ^ flags.ProcessorStatusFlags.Z[flags.Z])
...
def test_mos6502_I_flag():
    ...
    # Test bitwise xor
    cpu.I = 0
    assert (cpu.I ^ flags.ProcessorStatusFlags.I[flags.I]) == (flags.ProcessorStatusFlags.I[flags.I] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.I])
    cpu.I = 1
    assert (cpu.I ^ flags.ProcessorStatusFlags.I[flags.I]) == (flags.ProcessorStatusFlags.I[flags.I] ^ flags.ProcessorStatusFlags.I[flags.I])
...
def test_mos6502_D_flag():
    ...
    # Test bitwise xor
    cpu.D = 0
    assert (cpu.D ^ flags.ProcessorStatusFlags.D[flags.D]) == (flags.ProcessorStatusFlags.D[flags.D] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.D])
    cpu.D = 1
    assert (cpu.D ^ flags.ProcessorStatusFlags.D[flags.D]) == (flags.ProcessorStatusFlags.D[flags.D] ^ flags.ProcessorStatusFlags.D[flags.D])
...
def test_mos6502_B_flag():
    ...
    # Test bitwise xor
    cpu.B = 0
    assert (cpu.B ^ flags.ProcessorStatusFlags.B[flags.B]) == (flags.ProcessorStatusFlags.B[flags.B] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.B])
    cpu.B = 1
    assert (cpu.B ^ flags.ProcessorStatusFlags.B[flags.B]) == (flags.ProcessorStatusFlags.B[flags.B] ^ flags.ProcessorStatusFlags.B[flags.B])
...
def test_mos6502_V_flag():
    ...
    # Test bitwise xor
    cpu.V = 0
    assert (cpu.V ^ flags.ProcessorStatusFlags.V[flags.V]) == (flags.ProcessorStatusFlags.V[flags.V] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.V])
    cpu.V = 1
    assert (cpu.V ^ flags.ProcessorStatusFlags.V[flags.V]) == (flags.ProcessorStatusFlags.V[flags.V] ^ flags.ProcessorStatusFlags.V[flags.V])
...
def test_mos6502_N_flag():
    ...
    # Test bitwise xor
    cpu.N = 0
    assert (cpu.N ^ flags.ProcessorStatusFlags.N[flags.N]) == (flags.ProcessorStatusFlags.N[flags.N] ^ flags.ProcessorStatusFlags.SET_ZERO[flags.N])
    cpu.N = 1
    assert (cpu.N ^ flags.ProcessorStatusFlags.N[flags.N]) == (flags.ProcessorStatusFlags.N[flags.N] ^ flags.ProcessorStatusFlags.N[flags.N])
