...
def test_cpu_instruction_SEI_IMPLIED_0x78(cpu: CPU) -> None:  # noqa: N802
    """Test SEI instruction sets interrupt disable flag on all CPU variants."""
    # given:
    initial_cpu: CPU = copy.deepcopy(cpu)

    cpu.flags[flags.I] = 0

    cpu.ram[0xFFFC] = instructions.SEI_IMPLIED_0x78
