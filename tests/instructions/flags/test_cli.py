...
def test_cpu_instruction_CLI_IMPLIED_0x58(cpu: CPU) -> None:  # noqa: N802
    """Test CLI instruction clears interrupt disable flag on all CPU variants."""
    # given:
    ...
    cpu.ram[pc] = instructions.CLI_IMPLIED_0x58
