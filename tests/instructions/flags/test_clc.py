...
def test_cpu_instruction_CLC_IMPLIED_0x18(cpu: CPU) -> None:  # noqa: N802
    """Test CLC instruction clears carry flag on all CPU variants."""
    # given:
    ...
    cpu.ram[pc] = instructions.CLC_IMPLIED_0x18
