...
def test_cpu_instruction_BEQ_RELATIVE_0xF0_branch_taken(cpu: CPU) -> None:  # noqa: N802
    ...
    # BEQ with offset +5
    cpu.ram[0xFFFC] = instructions.BEQ_RELATIVE_0xF0
    cpu.ram[0xFFFD] = 0x05
...
def test_cpu_instruction_BEQ_RELATIVE_0xF0_branch_not_taken(cpu: CPU) -> None:  # noqa: N802
...
def test_cpu_instruction_BEQ_RELATIVE_0xF0_negative_offset(cpu: CPU) -> None:  # noqa: N802
    """Test BEQ with negative offset (branch backward)."""
    # given:
    ...
    # BEQ with offset -10 (0xF6 in two's complement)
    cpu.ram[0x0200] = instructions.BEQ_RELATIVE_0xF0
...
def test_cpu_instruction_BEQ_RELATIVE_0xF0_page_boundary_cross(cpu: CPU) -> None:  # noqa: N802
    """Test BEQ with page boundary crossing (costs extra cycle)."""
    # given:
    ...
    cpu.ram[0x02FD] = instructions.BEQ_RELATIVE_0xF0
    cpu.ram[0x02FE] = 0x05
