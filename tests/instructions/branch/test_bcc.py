...
def test_cpu_instruction_BCC_RELATIVE_0x90_branch_taken(cpu: CPU) -> None:  # noqa: N802
    """Test BCC when carry flag is clear (branch taken)."""
    # given:
    ...
    # BCC with offset +5
    cpu.ram[0xFFFC] = instructions.BCC_RELATIVE_0x90
    cpu.ram[0xFFFD] = 0x05
...
def test_cpu_instruction_BCC_RELATIVE_0x90_branch_not_taken(cpu: CPU) -> None:  # noqa: N802
    """Test BCC when carry flag is set (branch not taken)."""
    # given:
...
def test_cpu_instruction_BCC_RELATIVE_0x90_negative_offset(cpu: CPU) -> None:  # noqa: N802
    """Test BCC with negative offset (branch backward)."""
    # given:
    ...
    # BCC with offset -10 (0xF6 in two's complement)
    cpu.ram[0x0200] = instructions.BCC_RELATIVE_0x90
...
def test_cpu_instruction_BCC_RELATIVE_0x90_page_boundary_cross(cpu: CPU) -> None:  # noqa: N802
    """Test BCC with page boundary crossing (costs extra cycle)."""
    # given:
    ...
    cpu.ram[0x02FD] = instructions.BCC_RELATIVE_0x90
    cpu.ram[0x02FE] = 0x05
