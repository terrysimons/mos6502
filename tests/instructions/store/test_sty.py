...
def test_cpu_instruction_STY_ABSOLUTE_0x8C(cpu: CPU) -> None:  # noqa: N802
...
def test_cpu_instruction_STY_ZEROPAGE_0x84(cpu: CPU) -> None:  # noqa: N802
    expected_flags: Byte = copy.deepcopy(cpu.flags)
...
def test_cpu_instruction_STY_ZEROPAGE_X_0x94(cpu: CPU) -> None:  # noqa: N802
    expected_flags: Byte = copy.deepcopy(cpu.flags)
