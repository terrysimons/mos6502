...
def test_cpu_instruction_TAY_IMPLIED_0xA8() -> None:  # noqa: N802
    # given:
...
def test_cpu_instruction_TAY_IMPLIED_0xA8_zero_flag() -> None:  # noqa: N802
    # given:
    cpu: mos6502.CPU = mos6502.CPU()
    cpu.reset()
    initial_cpu: mos6502.CPU = copy.deepcopy(cpu)
...
def test_cpu_instruction_TAY_IMPLIED_0xA8_negative_flag() -> None:  # noqa: N802
    # given:
    cpu: mos6502.CPU = mos6502.CPU()
    cpu.reset()
    initial_cpu: mos6502.CPU = copy.deepcopy(cpu)
