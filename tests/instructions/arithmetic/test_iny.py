...
def test_cpu_instruction_INY_IMPLIED_0xC8() -> None:  # noqa: N802
    # given:
...
def test_cpu_instruction_INY_IMPLIED_0xC8_zero_flag() -> None:  # noqa: N802
    # given:
    cpu: mos6502.CPU = mos6502.CPU()
    cpu.reset()
    initial_cpu: mos6502.CPU = copy.deepcopy(cpu)
...
def test_cpu_instruction_INY_IMPLIED_0xC8_negative_flag() -> None:  # noqa: N802
    # given:
    cpu: mos6502.CPU = mos6502.CPU()
    cpu.reset()
    initial_cpu: mos6502.CPU = copy.deepcopy(cpu)
