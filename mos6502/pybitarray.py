...
class pybitarray:
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union["pybitarray, int"]:
    ...
    def __lt__(self, other: "pybitarray") -> bool:
        """Less than comparison (compares integer values)."""
        if isinstance(other, pybitarray):
            return ba2int(self) < ba2int(other)
        return NotImplemented

    def __le__(self, other: "pybitarray") -> bool:
        """Less than or equal comparison."""
        if isinstance(other, pybitarray):
            return ba2int(self) <= ba2int(other)
        return NotImplemented

    def __gt__(self, other: "pybitarray") -> bool:
        """Greater than comparison."""
        if isinstance(other, pybitarray):
            return ba2int(self) > ba2int(other)
        return NotImplemented

    def __ge__(self, other: "pybitarray") -> bool:
