...
class MemoryUnit:
    ...
    @underflow.setter
    def underflow(self, underflow) -> None:
    ...
    def __format__(self, specifier) -> str:
...
class RAM(MutableSequence):
    ...
    def memory_section(self, address) -> Literal["zeropage", "stack", "heap"]:
