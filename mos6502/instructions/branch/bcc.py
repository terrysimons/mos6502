...
def add_bcc_to_instruction_set_enum(instruction_set_class) -> None:
    ...
    member = PseudoEnumMember(BBC_RELATIVE_0x90, 'BBC_RELATIVE_0x90')
    instruction_set_class._value2member_map_[BBC_RELATIVE_0x90] = member
    setattr(instruction_set_class, 'BBC_RELATIVE_0x90', BBC_RELATIVE_0x90)
