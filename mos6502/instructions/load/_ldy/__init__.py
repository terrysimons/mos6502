...
LDY_IMMEDIATE_0xA0 = InstructionOpcode(
    0xA0,
    "mos6502.instructions.load._ldy",
    "ldy_immediate_0xa0"
)

LDY_ZEROPAGE_0xA4 = InstructionOpcode(
    0xA4,
    "mos6502.instructions.load._ldy",
    "ldy_zeropage_0xa4"
)

LDY_ZEROPAGE_X_0xB4 = InstructionOpcode(
    0xB4,
    "mos6502.instructions.load._ldy",
    "ldy_zeropage_x_0xb4"
)

LDY_ABSOLUTE_0xAC = InstructionOpcode(
    0xAC,
    "mos6502.instructions.load._ldy",
    "ldy_absolute_0xac"
)

LDY_ABSOLUTE_X_0xBC = InstructionOpcode(
    0xBC,
    "mos6502.instructions.load._ldy",
    "ldy_absolute_x_0xbc"
)
...
def register_ldy_instructions(instruction_set_class, instruction_map: dict) -> None:
    ...
    ldy_can_modify_flags: Byte = Byte()
    ldy_can_modify_flags[flags.N] = True
    ldy_can_modify_flags[flags.Z] = True
