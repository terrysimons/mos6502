...
class OceanType1Cartridge(Cartridge):
    ...
    organized as up to 64 × 8KB banks. Bank selection is via $DE00.

    Control register at $DE00 (directly accent write only):
...
class MagicDeskCartridge(Cartridge):
    ...
    organized as up to 64 × 8KB banks. Bank selection and cartridge
...
class C64GSCartridge(Cartridge):
    ...
    organized as up to 64 × 8KB banks. Bank selection is controlled
